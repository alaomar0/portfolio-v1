...
//sidenav store
export const useSideNav = create<SidNavState>()((set) => ({
  isOpen: false,
  ...
  return (
    <nav
      className={cn(
        ...
        "absolute top-0 right-0 -z-10 flex h-dvh w-0 flex-col overflow-hidden bg-white pt-[calc(48px+2rem)] transition-[width] duration-300 md:hidden dark:bg-black",
        isOpen && "w-dvw",
      )}
      style={{
